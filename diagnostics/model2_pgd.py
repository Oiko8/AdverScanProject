...
def plot_trajectory(trajectory, d4_fired, epsilon=8/255):
    ...
    save_path = os.path.join(OUTPUT_DIR, "model2_d4_loss_trajectory.png")
...
def run():
    ...
    pgd_accuracies = [88.7, 82.2, 73.8, 53.7, 14.4]
    ...
    summary_lines.append("  Model 2 — D1 and D4 Diagnostic Checks")
    summary_lines.append("=" * 55)
    ...
    save_report("part3_pgd.txt", summary)
