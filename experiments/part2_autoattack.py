...
def run():
    ...
    print("=" * 65)
    print("  Model 1 — Week 2: AutoAttack Evaluation + Diagnostics")
...
# ── Final diagnostic summary ──────────────────────────────────
    ...
    plt.title(
        "Model 1 — Stage 1 (PGD) vs Stage 2 (AutoAttack)\n"
    ...
    save_path = os.path.join(OUTPUT_DIR, "model1_stage1_vs_stage2.png")
